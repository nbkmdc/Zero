...
>(({ className, showOverlay = false, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      showOverlay ? 'bg-black/50 backdrop-blur-sm' : 'dark:bg-dark-background bg-[#FAFAFA]',
      className,
    )}
    {...props}
  />
...
>(({ className, children, showOverlay = false, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'z-100 fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] duration-200',
        ...
        showOverlay
          ? 'bg-panel-light dark:bg-panel-dark w-full max-w-[500px] rounded-xl border p-6'
          : '',
        className,
      )}
      {...props}
